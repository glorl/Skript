...
\newcommand{\changefont}[3]{				% Befehle zum einfachen Ändern der Schriftart (KOMA-Skript-Standard
...
%\usepackage[paperwidth=17cm,paperheight=24cm,top=15.5mm,inner=20.5mm,outer=18.5mm,includeheadfoot]{geometry}  %Einstellen der Seitengeometrie und des Druckbereichs für Originalformat 17x24cm
% !!!!! Beim Originalformat Schriftgröße 10pt verwenden
\usepackage[a4paper%,total={15.5cm,23.5cm}
,top=19mm,bottom=19mm,inner=25.5mm,outer=23mm,includeheadfoot]{geometry}	%Einstellen der Seitengeometrie und des Druckbereichs für A4 Format
...
% horizontale Ausrichtung von Überschriften 
...
\usepackage{mathrsfs}                % Für Sonderzeichen, z.B. Lagrange \mathscr{}
\usepackage{amsmath,amssymb,amsbsy,amsthm}  % AMS-Style


\usepackage{units}	            		 % Setzen von Einheiten nicht kursiv in Formeln
% \usepackage{undertilde}							 % Paket für Tilden unter Buchstaben
...
\usepackage{footnpag}           % Sorgt dafür, dass die Fussnotennummerierung mit jeder neuen Seite wieder bei 1 startet.
\usepackage{longtable}


%---- Verzeichnisse ----
\usepackage[printonlyused]%
{acronym}					% Paket für die Erstellung des Abkürzungsverzeichnisses
...
\usepackage[numbers]{natbib}    % Für Literaturdarstellung
%\usepackage{multibib}
...
\RequirePackage{ifthen}					% Package zum unterteilen des Symbolverzeichnisses benötigt
\newcommand{\nomunit}[1]{\renewcommand{\nomentryend}{\hspace*{\fill}#1}} % Ermöglicht Spalte für Einheit beim Formelverzeichnis
% Untergruppen im Symbolverzeichnis anlegen:
\renewcommand{\nomgroup}[1]{%
	\ifthenelse{\equal{#1}{I}}{\item[\textbf{Indizes\\}]}{
		\ifthenelse{\equal{#1}{S}}{\item[\textbf{Symbole}]}}}
\newcommand{\Symbol}[3]{\nomenclature[S]{$#1$}{#2 \nomunit{$\left[\unit{#3}\right]$} }} % Zum einfachen Einfügen von Symbolen mit Makebox
\makeindex



%====== Definitionsänderungen für den \Autoref-Befehl ====================================

% ACHTUNG LATEX SPEZIAL: Die Eintraege muessen mit % enden sonst gibt es ueberfluessige Leerzeichen
\makeatletter  
\let\orgautoref\autoref% Für alle, denen "`Unterunterabschnitt"' grotesk anmutet
...
{\def\sectionautorefname{Abschnitt}%
	...
	\orgautoref}%
% Definition der Pluralform ... für alle, die Pluralformen verwenden wollen 
...
%--- Veränderte Schriftart ------
% Latex Standard für Druck in Unidruckerei nicht erlaubt!
...
% Schriftgröße von Bildunterschriften
...
% Hurenkinder und Schusterjungen verhindern (für Druckerei)
\clubpenalty10000
\widowpenalty10000
