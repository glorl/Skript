...
Die Bewegungsgleichung lautet mit Anfangsbedingungen
	...
	\end{align}
Der Impuls lässt sich im Experiment als Hammerschlag realisieren. Aus der Impulsantwort (Gl. \ref{eq:ImpAntwort}) lassen sich die Systemparameter $m$, $d$, $D$ bestimmen. 
...
\begin{itemize}
	...
	\item Der Anteil $\hat x_1\cos (\Omega t+\varphi_1)$ heißt \emph{Grundschwingung} oder \emph{1. Harmonische}
	\item Der Anteil $\hat x_2\cos (2\Omega t+\varphi_2)$ heißt \emph{1. Oberschwingung} oder \emph{2. Harmonische}
	\item Der Anteil $\hat x_k\cos (k \Omega t+\varphi_k)$ heißt \emph{(k-1)-te Oberschwingung} oder \emph{k-te Harmonische}
